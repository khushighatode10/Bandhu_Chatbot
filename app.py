...
model = load_model('C:/Users/Khushi/chatbot_bandhu/chatbot/model.h5')
intents = json.loads(open('C:/Users/Khushi/chatbot_bandhu/chatbot/data.json').read())
words = pickle.load(open('C:/Users/Khushi/chatbot_bandhu/chatbot/texts.pkl', 'rb'))
classes = pickle.load(open('C:/Users/Khushi/chatbot_bandhu/chatbot/labels.pkl', 'rb'))
...
def fetch_timetable_from_db(year, day):
    ...
    if year == 'second':
        ...
        return None  # Handle invalid year
...
def get_timetable(year, day):
    ...
    if timetable_data:
        ...
        return f"⚠️ No timetable found for {year} year on {day}."
